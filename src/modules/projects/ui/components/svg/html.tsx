...
export function HtmlSvg({style}: {style: StyleInterface}){
    return(
        <div style={{width: style.width, height: style.height}}>
            <svg xmlns="http://www.w3.org/2000/svg" style={{width: "full", height: "full"}} viewBox="-1 0 20 20" version="1.1">
                ...
                <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    <g id="Dribbble-Light-Preview" transform="translate(-61.000000, -7639.000000)" style={{fill: style.fill}}>
