...
export function CssSvg({style}: {style: StyleInterface}){
    return(
        <div style={{width: style.width, height: style.height}}>
            <svg xmlns="http://www.w3.org/2000/svg" style={{fill: style.fill, width: "full", height: "full"}} version="1.1" viewBox="0 0 512 512" enableBackground="new 0 0 512 512">
