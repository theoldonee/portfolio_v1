...
export function ExpressSvg({style}: {style: StyleInterface}){
    return(
        <div style={{width: style.width, height: style.height}}>
            <svg xmlns="http://www.w3.org/2000/svg" style={{width: "full", height: "full", fill: style.fill}} viewBox="0 0 24 24" role="img">
