...
export function MongoSvg({style}: {style: StyleInterface}){
    return(
        <div style={{width: style.width, height: style.height}}>
            <svg xmlns="http://www.w3.org/2000/svg"style={{width: "full", height: "full"}} viewBox="0 0 1024 1024">
            <circle cx="512" cy="512" r="512" style={{fill: "none", stroke: style.fill, strokeWidth: 16}}/>
