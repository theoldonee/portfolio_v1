...
export const ExperienceSection = () =>{
    return(
        <div className=" w-full h-[calc(100vh-100px)] bg-gray-200 flex items-center justify-center gap-5 relative z-10" id="Experience">
            <div className="w-1/2 flex flex-col items-center gap-20 border-1 border-black p-60">
